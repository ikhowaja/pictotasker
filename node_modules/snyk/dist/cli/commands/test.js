...
function displayResult(res, options) {
    ...
    options.canSuggestRemediation = detect_1.isLocalFolder(options.path);
    ...
    if (res.ok && res.vulnerabilities.length === 0) {
        ...
        const nextStepsText = '\n\nNext steps:' +
            ...
            'your CI/test.';
        return (prefix + meta + summaryOKText + multiProjAdvice + (isCI ? '' :
            dockerAdvice +
                nextStepsText +
                dockerSuggestion));
    }
    ...
    if (options.canSuggestRemediation && common_1.WIZARD_SUPPORTED_PMS.indexOf(packageManager) > -1) {
